...
class Options_Name
{
    ...
    const ONLY_SHOW_FOR_LOGGEDIN_USER = 'only_show_for_loggedin_user';
    ...
    const HIDE_CART_ON_CURSOR_OUT = 'hide_cart_on_cursor_out';
    ...
    const SINGLE_ITEM_TITLE_COLOR = 'single_item_title_color';
    const SINGLE_ITEM_TITLE_FONT_SIZE = 'single_item_title_font_size';


    const MENU_CART_LINK_MENUS = 'bc_menu_cart_linked_menu';
    ...
    const DISPLAY_CLOSE_CART_LINK = 'display_close_cart_link';
    const DISPLAY_CLOSE_CART_TEXT = 'display_close_cart_text';
    ...
    const CLOSE_CART_LIST_ICON_COLOR = 'close_cart_list_icon_color';
...
//    const DISPLAY_PRICE_INCLUDING_TAX = 'display_item_in_minicart_including_tax';
    ...
    const PRODUCT_REMOVE_BUTTON_COLOR = 'product_remove_button_color';
    ...
    const DESIGN_DESKTOP_POSITION = 'design_desktop_position';
    const DESIGN_DESKTOP_POSITION_RELATIVE_TO_ELEMENT = 'design_desktop_position_relative_to_element';
    ...
    const QUANTITY_CHANGE_BOX_ICON_COLOR = 'quantity_change_box_icon_color';
    const QUANTITY_CHANGE_BOX_QUANTITY_COLOR = 'quantity_change_box_quantity_color';
