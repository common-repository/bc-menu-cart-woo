...
?>
        ...
        if ($action == 'trash' && $option_post_id != 0) {
            if (!wp_verify_nonce($_GET['_wpnonce'], 'bc-mnc-trash-design')) {
                error_log('Security check failed');
                die(__('Security check failed', 'bc-menu-cart-woo'));
            }

            if (!current_user_can('edit_posts')) {
                wp_die(__('You don not have the rights to continue', 'bc-menu-cart-woo'));
            }

            error_log('Security check passed, go ahead and delete');
                    ...
                    <div class="bc-uk-width-1-1@m">
                        ...
                        <ul class="bc-uk-switcher" id="bc-menu-cart-top-tab">
                                    ...
                                    <div class="bc-uk-flex bc-uk-grid">
                                        ...
                                        <div class="bc-uk-width-1-2">
                                            ...
                                            ?>
                                                    ...
                                                    <button id="activate-license-button" class="bc-uk-button-primary bc-uk-button">Activate license
                                                    </button>
                                            <?php
                                                }
                                            } ?>
                                ...
                                <div class="bc-uk-flex" bc-uk-grid>
                                    <div class="bc-uk-width-auto@m">
                                        ...
                                        foreach ($all_cart_designs as $design) {
                                            echo sprintf('<li><a href="%1$s"><i class="icon-edit-01"></i></a> <a href="%2$s"><i class="icon-trash-01"></i></a>%3$s</li>', wp_nonce_url(admin_url('admin.php?page=bc_menu_bar_cart&active_tab=create-design-tab&action=edit&option_id=' . $design->ID)), wp_nonce_url(admin_url('admin.php?page=bc_menu_bar_cart&active_tab=create-design-tab&action=trash&option_id=' . $design->ID), 'bc-mnc-trash-design'), $design->post_title);
                                        }
                                            ...
                                            <ul class="bc-uk-switcher" id="bc-menu-cart-settings-tabs">
                                                ...
                                                <li id="general-tab">
                                                    ...
                                                    $general_bc_ui->card_section(__('Cart display', 'bc-menu-cart-woo'), array(
                                                        ...
                                                        $general_bc_ui->checkbox(OName::ONLY_SHOW_FOR_LOGGEDIN_USER, false, __('Only show for logged in users', 'bc-menu-cart-woo'), false),
                                                ...
                                                <li id="design-tab">
                                                    ...
                                                    $general_bc_ui->card_section(__('Cart icon design', 'bc-menu-cart-woo'), array(
                                                        ...
                                                        Config::IS_FREE ? Static_UI::notice(
                                                            __('Cart icon color  is available in the pro version only. <a href="https://www.binarycarpenter.com/app/bc-menu-cart-icon-plugin/?src=in-plugin-cart-color">Click here to upgrade</a> to unlock all features', 'bc-menu-cart-woo'),
                                                            'info',
                                                            false,
                                                            false
                                                        ) : '',
                                                    ...
                                                    $general_bc_ui->card_section(
                                                        __('Cart count circle design', 'bc-menu-cart-woo'),
                                                        array(
                                                    ...
                                                    $general_bc_ui->card_section(
                                                        __('Single item in cart details colors', 'bc-menu-cart-woo'),
                                                        array(
                                                    ...
                                                    $general_bc_ui->card_section(__('Move the cart icon on desktop', 'bc-menu-cart-woo'), array(
                                                        Static_UI::flex_section(array(

                                                            $general_bc_ui->radio(OName::DESIGN_DESKTOP_POSITION, array(
                                                                'nothing' => array('content' => __('Do nothing', 'bc-menu-cart-woo'), 'disabled' => false),
                                                                'left' => array('content' => __('Left', 'bc-menu-cart-woo'), 'disabled' => false),
                                                                'right' => array('content' => __('Right', 'bc-menu-cart-woo'), 'disabled' => false),
                                                                'inside' => array('content' => __('Inside', 'bc-menu-cart-woo'), 'disabled' => Config::IS_FREE),

                                                            ), 'column', 'text', __('Position against an element', 'bc-menu-cart-woo')),
                                                        ), 'bc-uk-flex-between'),

                                                        Static_UI::flex_section(array(
                                                            $general_bc_ui->input_field(OName::DESIGN_DESKTOP_POSITION_RELATIVE_TO_ELEMENT, 'text', __('Element selector (the element that the cart icon is positioned against)', 'bc-menu-cart-woo'), Config::IS_FREE),
                                                        ), 'bc-uk-flex-between'),
                                                    ...
                                                    $general_bc_ui->card_section(__('Other cart list settings', 'bc-menu-cart-woo'), array(
                                                        ...
                                                        $general_bc_ui->checkbox(OName::DISPLAY_GO_TO_CART_BUTTON, false, __('Display go to cart button', 'bc-menu-cart-woo')),
                                                        Static_UI::flex_section(array(
                                                        ...
                                                        $general_bc_ui->checkbox(OName::DISPLAY_GO_TO_CHECKOUT_BUTTON, false, __('Display go to checkout button'), 'bc-menu-cart-woo'),
                                                        Static_UI::flex_section(array(
                                                        ...
                                                        $general_bc_ui->checkbox(OName::DISPLAY_CLOSE_CART_LINK, false, __('Display close cart link at the bottom of the cart, on mobile'), 'bc-menu-cart-woo'),
                                                        $general_bc_ui->input_field(OName::DISPLAY_CLOSE_CART_TEXT, 'text', __('Go to cart button text', 'bc-menu-cart-woo'), false)
                            ...
                            <li class="bc-single-tab" id="link-design-to-menu-tab">
                                ...
                                <p>Please select the design for your menus (These are the menu you created in
                                    Appearance->Menu section)</p>
                                <form class="bc-uk-form">
                                    <?php
